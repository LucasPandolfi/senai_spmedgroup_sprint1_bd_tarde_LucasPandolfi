...
SELECT Consulta.IdConsulta, Situacao.Estatus, Consulta.Data_Consulta, Prontuario.NomePaciente
FROM Consulta
...
SELECT Consulta.IdConsulta, Situacao.Estatus, Consulta.Data_Consulta, Medico.NomeMedico, Prontuario.NomePaciente, Prontuario.CPF
FROM Consulta
INNER JOIN Situacao ON Situacao.IdSituacao = Consulta.IdSituacao
